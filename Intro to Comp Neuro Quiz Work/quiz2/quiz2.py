#explination:
"""
This script loads a .mat file containing a stimulus signal (stim) 
and a spike train (rho). It sets up the sampling parameters, figures 
out how many time steps fit into a 300 ms window, and then counts 
how many spikes occurred after that first 300 ms period. Useful for 
checking spike counts relative to stimulus timing.
"""
